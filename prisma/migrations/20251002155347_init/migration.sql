...
-- AddForeignKey
ALTER TABLE "public"."order_items" ADD CONSTRAINT "order_items_bundleId_fkey" FOREIGN KEY ("bundleId") REFERENCES "public"."bundles"("id") ON DELETE SET NULL ON UPDATE CASCADE;
